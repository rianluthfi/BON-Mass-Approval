 ...
 * 
 * previous version at 
 * Suitelet     : BCG SL Mass Approval CEO
 * Script ID    : customscript_bcg_sl_mass_approval_ceo
 * script Name  : bcg_sl_mass_po_ceo.js
 */
        ...
        const onRequest = (scriptContext) => {
            ...
            if (scriptContext.request.method === 'GET') {
                ...
                var form = serverWidget.createForm({
                    title: 'Mass Approve PO by CEO',
                    hideNavBar: false
                });

                form.clientScriptModulePath = 'SuiteScripts/MassApprovals/bon_cs_mass_app_po_afam.js';

                var dataSearch = bonApproveModule.getSearchPOtoApproveByCEO(PAGE_SIZE, subsidiary, location, startdate, enddate);
                ...
                if (dataSearch.count > 0) {
                    ...
                    var dataResults = bonApproveModule.getDataPOtoApproveByCEO(dataSearch, pageId);
